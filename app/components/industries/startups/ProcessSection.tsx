...
const steps = [
  {
    number: "1",
    name: "Domain Setup",
    body: "Already have a domain? We'll connect it. Need one? I'll help you find and purchase the right domain under your startup's name.",
  },
  {
    number: "2",
    name: "Architecture",
    body: "Structuring your product story, features, pricing, and sign-up flow, and setting up connections to your analytics, email, and CRM tools.",
  },
  {
    number: "3",
    name: "Design & Build",
    body: "Custom UI/UX design and development tailored to your brand and product, optimized for speed and performance across all devices.",
  },
  {
    number: "4",
    name: "Launch & QA",
