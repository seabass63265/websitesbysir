...
const steps = [
  {
    number: "1",
    name: "Domain Setup",
    body: "Already have a domain? We'll connect it. Need one? I'll help you find and purchase the right domain under your name or brand.",
  },
  {
    number: "2",
    name: "Architecture",
    body: "Structuring your portfolio, services, story, and testimonials, and setting up connections to your booking, social, and newsletter platforms.",
  },
  {
    number: "3",
    name: "Design & Build",
    body: "Custom UI/UX design and development that shows off your work and personality, optimized for performance across all devices.",
  },
  {
    number: "4",
    name: "Launch & QA",
