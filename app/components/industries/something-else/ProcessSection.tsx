...
const steps = [
  {
    number: "1",
    name: "Domain Setup",
    body: "Already have a domain? We'll connect it. Need one? I'll help you find and purchase the right domain under your project's name.",
  },
  {
    number: "2",
    name: "Architecture",
    body: "Talking through your goals and audience, mapping out the pages and features you need, and setting up connections to the tools you already use.",
  },
  {
    number: "3",
    name: "Design & Build",
    body: "Custom UI/UX design and development built around your idea, not a template, optimized for performance across all devices.",
  },
  {
    number: "4",
    name: "Launch & QA",
