...
const steps = [
  {
    number: "1",
    name: "Domain Setup",
    body: "Already have a domain? We'll connect it. Need one? I'll help you find and purchase the right domain under your business's name.",
  },
  {
    number: "2",
    name: "Architecture",
    body: "Structuring your services, pricing, locations, and setting up connections to your booking and scheduling platforms.",
  },
  {
    number: "3",
    name: "Design & Build",
    body: "Custom UI/UX design and development tailored to your brand, optimized for performance across all devices.",
  },
  {
    number: "4",
    name: "Launch & QA",
